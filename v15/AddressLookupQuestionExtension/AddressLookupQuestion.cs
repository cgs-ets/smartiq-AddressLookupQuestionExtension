...
namespace AddressLookupQuestionExtension
{
    public class AddressLookupQuestion : Intelledox.Extension.CustomQuestion.CustomQuestionExtension
    {
        ...
        public override void WriteHtml(string controlPrefix, CustomQuestionProperties props, TextWriter writer)
        {
            ...
            writer.Write("<input type=\"text\" name=\"" + controlPrefix + "\" id=\"" + controlPrefix + "\" placeholder=\"Start typing an address\" class=\"form-control form-control-sm q-prompt\" autocomplete=\"off\" data-type=\"Text\" spellcheck=\"false\"");
